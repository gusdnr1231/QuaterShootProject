...
public class AgentAnimator : MonoBehaviour
{
	...
	public void SetAttackTrigger(bool value)
	{
		...
		else _animator.ResetTrigger(_attackHash); //이전 트리거 값이 남아있지 않도록 지워져야 한다.
	}

	public void SetHurtTrigger(bool value)
	{
		if (value) _animator.SetTrigger(_hurtTriggerHash);
		else _animator.ResetTrigger(_hurtTriggerHash);
	}*/
	#endregion
